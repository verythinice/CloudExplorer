define(['underscore', 'backbone', 'model/objModel'],
	function(_, Backbone, ObjModel) {
		...
		var objCollection = Backbone.Collection.extend({
					...
					removeDuplicates: function(myArray) {
						...
						// credit:
						// http://newcodeandroll.blogspot.ca/2012/01/how-to-find-duplicates-in-array-in.html
						// I was hoping underscore's _uniq would work here
						// but it only seems to work for single values not
						// objects
